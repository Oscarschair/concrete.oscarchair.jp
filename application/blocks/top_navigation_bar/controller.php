...
namespace Application\Block\TopNavigationBar;
use Concrete\Block\TopNavigationBar\Controller as TopNavigationBarBlockController;
...
class Controller extends TopNavigationBarBlockController implements UsesFeatureInterface, FileTrackableInterface
{
    public $helpers = ['form'];
