...
<div data-transparency="element" class="ccm-block-hero-image pc" <?php if ($height) { ?>style="min-height: <?=$height?>vh"<?php } ?>>
    <div class="ccm-block-hero-image-cover" style="<?php if ($height) { ?>min-height: <?=$height?>vh;<?php } ?><?php if ($filterColor) { ?>background: <?=$filterColor?> !important;<?php } ?><?php if ($filterOpacity) { ?>opacity: <?=$filterOpacity/100?>;<?php } ?>"></div>
