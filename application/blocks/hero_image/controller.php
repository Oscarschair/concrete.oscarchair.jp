...
use Concrete\Block\HeroImage\Controller as HeroImageBlockController;
...
class Controller extends HeroImageBlockController implements FileTrackableInterface, UsesFeatureInterface
{
    public $helpers = ['form'];
